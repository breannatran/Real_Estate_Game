...
This project includes a class called RealEstateGame that allows two or more people to play a very simplified version of the game [Monopoly](https://en.wikipedia.org/wiki/Monopoly_(game)).
...
The code for the game defines the class and methods described below. All data members must be **private**.
**RealEstateGame:**

The RealEstateGame object represents the game as played. The class has these methods:
...
As a simple example, the game could be played as follows:
```
game = RealEstateGame()
